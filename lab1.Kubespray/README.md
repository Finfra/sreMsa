...
| Folder                                                         | Contents                                                                                                                                                                                |
| -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [install_basic.md](install_basic.md)                           | **① 기본 설치** — 프로그램·Windows 설정·소스 내려받기 (0~1장). `_prgs` 폴더에도 동봉                                                                                                    |
| [Install_Kubernetes_only_PC.md](Install_Kubernetes_only_PC.md) | **② 단계별 절차서** — VM 만들기부터 Kubespray 까지 (2장~)                                                                                                                               |
