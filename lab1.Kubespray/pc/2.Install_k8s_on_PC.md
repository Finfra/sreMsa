...
```bash
cd ~/sreMsa/lab1.Kubespray/pc/vm_x_4
...
* box 업데이트 확인도 꺼 두었다([settings.yml](vm_x_4/settings.yml) 의 `box.check_update`).
...
| 메모리가 모자라 PC 가 멈춘다                                        | [vm_x_4/README.md](vm_x_4/README.md) 의 "메모리가 부족할 때"                                                                              |
...
이 실습은 [settings.yml](vm_x_4/settings.yml) 에서 대기 시간을 **900초**로 늘려 두었으므로
...
* [vm_x_4/README.md](vm_x_4/README.md) — 구성 상세, AWS·Terraform 과의 대조표, 노드 추가 실습
