...
| 폴더·파일                                                 | 무엇인가                                              |
| :-------------------------------------------------------- | :---------------------------------------------------- |
| [1.install_APP_on_PC.md](1.install_APP_on_PC.md)          | **① 기본 설치** — 프로그램·Windows 설정·소스 내려받기 |
| [2.Install_k8s_on_PC.md](2.Install_k8s_on_PC.md)          | **② 단계별 절차서** — VM 만들기부터 Kubespray 까지    |
...
* **AWS 경로의 `2.aws.Create_IAM_Key` 에 해당하는 것이 없다.** 자격증명이 필요 없는 로컬 환경이라 번호 2를 비워 둔다.
...
**수강생 배포를 VM 하나로 끝내야 하는 상황이 아니라면 [1.pc.byVagrant](1.pc.byVagrant/) 가 안전하다.** 16GB PC 에서 실측으로 전 과정을 통과한 경로이며, 수강생용 단계별 절차인 [2.Install_k8s_on_PC.md](2.Install_k8s_on_PC.md) 도 이 폴더를 기준으로 쓰여 있다.
...
[1.pc.byVagrant](1.pc.byVagrant/) 는 수강생이 직접 만든다 — 절차는 [2.Install_k8s_on_PC.md](2.Install_k8s_on_PC.md) 9.1 절에 있다.
