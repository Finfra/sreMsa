...
> **AWS 계정이 없다면** 이 경로 대신 [1.install_APP_on_PC.md](../../pc/1.install_APP_on_PC.md) 로 간다.
...
| **2** | 콘솔 서버 `i1` 을 EC2 로 생성               | [1.aws.byTerraform](README.md) Step1   |
| **3** | `i1` 에 Terraform·Ansible·AWS CLI 설치      | [1.aws.byTerraform](README.md) Step3~4 |
...
→ **[1.aws.byTerraform](README.md)** 의 Step1 을 따른다.
...
→ **[1.aws.byTerraform](README.md)** 의 Step3 을 따른다.
